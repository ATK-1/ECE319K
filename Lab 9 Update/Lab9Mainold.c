...
//  ST7735_DrawBitmap(4,158,red_zero_noBG , 25,35);
  ST7735_DrawBitmap(4,50,blue_2 , 25,35);
  ST7735_DrawBitmap(33,50,red_4 , 25,35);
  ST7735_DrawBitmap(62,50,green_7 , 25,35);
  ST7735_DrawBitmap(91,50,yellow_5 , 25,35);

  for(int16_t height=158; height != 48; height--){
      ST7735_DrawBitmap(4,height,blue_8 , 25,35);
      ST7735_DrawBitmap(4,height+1,BlackLine , 25,1);

      ST7735_DrawBitmap(33,height,green_6 , 25,35);
      ST7735_DrawBitmap(33,height+1,BlackLine , 25,1);

      ST7735_DrawBitmap(62,height,yellow_1 , 25,35);
      ST7735_DrawBitmap(62,height+1,BlackLine , 25,1);

      ST7735_DrawBitmap(91,height,red_0 , 25,35);
